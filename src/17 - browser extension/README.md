...
3. Enter your credentials:
   - **Tenant ID**: Your Azure AD tenant ID (from app registration)
...
- **Azure AD Authentication**: Refer to [Microsoft Identity Platform documentation](https://learn.microsoft.com/azure/active-directory/)
...
Inspired by Microsoft Security Copilot capabilities and built using:
- Microsoft Graph API
- Microsoft Identity Platform
- Edge Extensions API (Manifest V3)
...
- [Edge Extensions Development](https://learn.microsoft.com/microsoft-edge/extensions-chromium/)
